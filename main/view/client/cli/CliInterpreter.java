...
public class CliInterpreter {
	...
	/**
	 * This map is used to parse the message without the used of if else clause to reduce
	 ...
	 * @param <W> Thirs input param
	 * @param <R> The result of the application of the fuction with the three params
	 ...
	 * word of the strings and it's rapresent the action that the player request to perform,
	 * and a Fuctional Interface as value that rapresent a fuction that take three param and return
	 ...
	 * This map has as key a string that rapresent the info to display, and a {@link BiConsumer} of
	 * Game and Token wich display the correct info.
	 */
